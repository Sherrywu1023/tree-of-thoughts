...
class OpenAILanguageModel(AbstractLanguageModel):
    ...
    def generate_thoughts(
        ...
        ###'{state_text}'\n\n###
        Devise the best possible solution for the task: {initial_prompt}. Be direct. Provide intuitive solutions as soon as you think of them."""
    ...
    def generate_solution(self, initial_prompt, state, rejected_solutions=None):
        try:
            ...
            Considering the reasoning provided:\n\n
            ###'{state_text}'\n\n###
            Devise the best possible solution for the task: {initial_prompt}. Be simple. Be direct. Provide intuitive solutions as soon as you think of them."""
